...
@interface NSValue (BMKGeometryExtension)

/// BMKMapPoint转NSValue
/// @param mapPoint BMKMapPoint结构体对象
/// @return NSValue对象
+ (NSValue *)valueWithBMKMapPoint:(BMKMapPoint)mapPoint;

/// BMKMapSize转NSValue
/// @param mapSize BMKMapSize结构体对象
/// @return NSValue对象
+ (NSValue *)valueWithBMKMapSize:(BMKMapSize)mapSize;

/// BMKMapRect转NSValue
/// @param mapRect BMKMapRect结构体对象
/// @return NSValue对象
