...
@property (nonatomic, assign) NSInteger restrictionsStatus;
/// 限行信息,如 "包含禁行路段|包含逆行路段"
@property (nonatomic, copy) NSString *restrictionsInfo;
@end
...
@property (nonatomic, assign) BOOL isSupportTraffic __deprecated_msg("已废弃since 2.7.0");;
