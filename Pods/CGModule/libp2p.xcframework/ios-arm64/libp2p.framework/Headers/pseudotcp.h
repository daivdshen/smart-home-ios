...
using gsize = uint32_t; // it should be 64 for 64 bit platforms...
using gchar = char;
using gpointer = void*;
...
typedef enum {
  PSEUDOTCP_LISTEN,
  PSEUDOTCP_SYN_SENT,
  PSEUDOTCP_SYN_RECEIVED,
  PSEUDOTCP_ESTABLISHED,
  PSEUDOTCP_CLOSED,
  PSEUDOTCP_FIN_WAIT_1,
  PSEUDOTCP_FIN_WAIT_2,
  PSEUDOTCP_CLOSING,
  PSEUDOTCP_TIME_WAIT,
  PSEUDOTCP_CLOSE_WAIT,
  PSEUDOTCP_LAST_ACK,
} PseudoTcpState;
...
// PORTING OF GObject functions
void g_object_ref(PseudoTcpSocket* self);
void g_object_unref(PseudoTcpSocket* self);
